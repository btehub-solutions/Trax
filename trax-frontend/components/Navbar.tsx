          ...
          <div className="flex items-center justify-between h-16 gap-6">
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <motion.button
                ...
                whileHover={{ backgroundColor: 'rgba(255, 26, 26, 0.08)' }}
                whileTap={{ scale: 0.88 }}
                className="p-2 rounded-lg transition-colors duration-200 hover:text-accent"
              ...
              <motion.a
                id="navbar-linkedin"
                href="https://www.linkedin.com/in/traxnewsng"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.88 }}
                className="md:hidden p-2 rounded-lg transition-colors duration-200 hover:text-accent"
                style={{ color: 'var(--fg)' }}
              >
                <AnimatePresence mode="wait" initial={false}>
                  {menuOpen ? (
