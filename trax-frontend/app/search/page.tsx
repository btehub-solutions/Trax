...
export async function generateMetadata({
  ...
  return pageMetadata({
    ...
    description: q
      ? `Trax articles matching "${q}" · Startups, funding, ecosystem, and tech news across Nigeria, Africa, and global frontiers.`
      : 'Search stories, startups, founders, funding rounds, and tech news across Africa and the world.',
    path: '/search',
  })
}
