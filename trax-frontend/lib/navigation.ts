...
export const primaryNav: NavItem[] = [
  {
    ...
    fallbackTitle: 'Tracking tech movements across Nigeria, Africa, and global corridors',
  },
  {
    label: 'News',
    href: '/news',
    markerTitle: 'News',
    categorySlug: 'news',
    fallbackTitle: 'Breaking technology dispatches from Africa and around the world',
  },
  {
    label: 'Startups',
    href: '/startups',
    ...
    fallbackTitle: 'Venture-backed startups and audacious builders',
  },
  {
    label: 'Funding',
    href: '/funding',
    ...
    fallbackTitle: 'Venture capital deals, angel rounds, and market liquidity',
  },
  {
    label: 'People',
    href: '/people',
    ...
    fallbackTitle: 'Founders, engineers, and visionaries shaping the future',
  },
  {
    label: 'Ecosystem',
    href: '/ecosystem',
    ...
    fallbackTitle: 'Policy, hubs, infrastructure, and continental digital movements',
  },
  {
    label: 'Events',
    href: '/events',
    markerTitle: 'Events',
    categorySlug: 'events',
    fallbackTitle: 'Flagship summits, tech conferences, and hackathons worldwide',
  },
  {
    label: 'Press',
    href: '/press',
