  ...
  const adSlotsSeed = [
    {
      ...
      size: 'LEADERBOARD',
      code: `<a href="https://oguntechhub.org" target="_blank" style="text-decoration: none; display: block; overflow: hidden; border-radius: 12px; border: 1px solid rgba(255,255,255,0.08);"><div style="background: linear-gradient(90deg, #111827 0%, #1c1917 50%, #292524 100%); color: #fff; display: flex; align-items: center; justify-content: space-between; padding: 0 24px; height: 90px; font-family: \'DM Sans\', sans-serif; box-sizing: border-box; width: 100%;"><div style="display: flex; flex-direction: column; justify-content: center; text-align: left;"><span style="font-size: 13px; font-weight: 800; letter-spacing: 0.05em; color: #C84B31; margin-bottom: 2px; text-transform: uppercase;">Ogun State Tech Hub</span><span style="font-size: 11px; color: #a8a29e;">Co-working, incubator programs, and fiber internet on Abeokuta-Kobape Road.</span></div><span style="background-color: #C84B31; color: #fff; font-size: 10px; font-weight: 700; padding: 8px 14px; border-radius: 8px; text-transform: uppercase; letter-spacing: 0.05em; white-space: nowrap;">Book Desk</span></div></a>`,
      active: true
    },
    {
      name: 'Sidebar Square Ad',
      size: 'RECTANGLE',
      code: `<a href="https://fatefoundation.org/orangecorners" target="_blank" style="text-decoration: none; display: block; overflow: hidden; border-radius: 16px; border: 1px solid rgba(200,75,49,0.2);"><div style="background: linear-gradient(135deg, #1c1917 0%, #292524 100%); color: #fff; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 28px 20px; min-height: 250px; text-align: center; font-family: \'DM Sans\', sans-serif; box-sizing: border-box; width: 100%;"><span style="background-color: rgba(200,75,49,0.1); color: #C84B31; border: 1px solid rgba(200,75,49,0.25); font-size: 9px; font-weight: 700; padding: 4px 10px; border-radius: 9999px; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 12px;">INCUBATION PROGRAM</span><h4 style="font-size: 16px; font-weight: 800; margin: 0 0 8px 0; color: #fff; line-height: 1.25;">Orange Corners Ogun State</h4><p style="font-size: 11px; color: #a8a29e; margin: 0 0 16px 0; line-height: 1.5;">Mentorship, workspaces, and funding grants up to €15,000 for young startup founders.</p><span style="background-color: #C84B31; color: #fff; font-size: 11px; font-weight: 700; padding: 9px 20px; border-radius: 8px; text-transform: uppercase; letter-spacing: 0.05em;">Apply Cohort 4</span></div></a>`,
      active: true
    },
    {
      name: 'Inline News Banner',
      size: 'INLINE',
      code: `<a href="https://oguntechcommunity.org" target="_blank" style="text-decoration: none; display: block; overflow: hidden; border-radius: 12px; border: 1px solid rgba(99,102,241,0.2);"><div style="background: linear-gradient(90deg, #1e1b4b 0%, #312e81 100%); color: #fff; display: flex; align-items: center; justify-content: space-between; padding: 0 24px; height: 120px; font-family: \'DM Sans\', sans-serif; box-sizing: border-box; width: 100%;"><div style="display: flex; flex-direction: column; justify-content: center; text-align: left;"><span style="background-color: rgba(99,102,241,0.2); color: #818cf8; border: 1px solid rgba(99,102,241,0.3); font-size: 9px; font-weight: 700; padding: 3px 8px; border-radius: 9999px; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px; width: fit-content;">COMMUNITY GATEWAY</span><h4 style="font-size: 15px; font-weight: 800; margin: 0 0 2px 0; color: #fff;">Ogun Tech Community</h4><p style="font-size: 11px; color: #c7d2fe; margin: 0;">Connect with 5,000+ local engineers, designers, and founders natively.</p></div><span style="background-color: #4f46e5; color: #fff; font-size: 11px; font-weight: 700; padding: 8px 16px; border-radius: 8px; text-transform: uppercase; letter-spacing: 0.05em; white-space: nowrap;">Join Community</span></div></a>`,
      active: true
    },
  ]
